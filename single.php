                    ...
                    <div class="right-element">
                        ...
                        if ($tags) {
                          echo '<div class="tag-section">';
                            echo '<p class="pera">Tags</p>';
                            echo '<div class="dotted">';
                              echo '<div class="active-dot"></div>';
                              echo '<div class="inactive-dot"></div>';
                            echo '</div>';
                            echo '<div class="tag-box">';
                                echo '<div class="tag-info">';
                                  foreach ($tags as $tag) {
                                      echo '<div class="badge"><p class="subtitle"><a href="' . esc_url(get_tag_link($tag->term_id)) . '">' . esc_html($tag->name) . '</a></p></div>';
                                  }
                                echo '</div>';
                            echo '</div>';
                          echo '</div>';
